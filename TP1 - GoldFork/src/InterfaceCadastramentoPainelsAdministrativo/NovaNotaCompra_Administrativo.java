 ...
 * @author Eymar Lima
 */
public class NovaNotaCompra_Administrativo extends javax.swing.JPanel {
    private Main pai;
     ...
     */
    public NovaNotaCompra_Administrativo(Main pai) {
        initComponents();
        this.pai=pai;
        valorTotalNota = 0.0f;
        //carregar lojas;
        lojas = BancoDeDados.recuperarNomeEIDLojas(pai.getIdUsuarioLogado());
        for (Loja loja : lojas) {           
            lojaBox.addItem(loja.getNome());
        }
    ...
    private void initComponents() {
        ...
        lojaBox = new javax.swing.JComboBox<String>();
        ...
        lojaBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lojaBoxActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(lojaBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lojaBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {fornecedorBox, jLabel6, jLabel7});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel8, lojaBox});
    ...
    private void lojaBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lojaBoxActionPerformed
        int linha = lojaBox.getSelectedIndex();
        this.carregarEatualizarFornecedores(linha);
    }//GEN-LAST:event_lojaBoxActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        //resgatando id da loja;
        int linha = lojaBox.getSelectedIndex();
        int idLanchonete = lojas.get(linha).getId_lanchonete();
    ...
    private void carregarEatualizarFornecedores(int id_loja){
        this.fornecedores = BancoDeDados.recuperarNomeEIDFornecedores(this.lojas.get(id_loja).getId_lanchonete());
    ...
    private javax.swing.JComboBox<String> lojaBox;
