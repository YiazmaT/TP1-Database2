...
import InterfaceCadastramentoPainelsAdministrativo.PanelLojaAuxiliarParaListagem;
 ...
 * @author Eymar Lima
 */
public class ModificarFornecedor extends javax.swing.JDialog {
    private Fornecedor fornecedor;
    private ArrayList<PanelLojaAuxiliarParaListagem> lojasPanel;
    private ArrayList<Loja> todasLojas;
    private Main pai;
    /**
     * Creates new form ModificarFornecedor
     */
    public ModificarFornecedor(java.awt.Frame parent, boolean modal, Fornecedor fornecedor, Main Pai, ArrayList<Loja> todasLojas) {
        super(parent, modal);
        initComponents();
        ...
        //introduzindo as lojas cadastradas
        ...
        //preencher lojas que ja estao sendo fonecidas;
        ArrayList<Loja> lojasFornecidas = BancoDeDados.recuperarLojasFornecidasPorUmFornecedor(this.fornecedor.getId_fornecedor());
        for(Loja atual : lojasFornecidas){
            for(PanelLojaAuxiliarParaListagem marcar : lojasPanel){
                if(atual.getId_lanchonete() == marcar.getLoja().getId_lanchonete()){
                    marcar.selecionar(true);
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        lojasDentroPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lojasDentroPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(telefoneField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lojasDentroPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButton1)
                .addContainerGap())
        );
